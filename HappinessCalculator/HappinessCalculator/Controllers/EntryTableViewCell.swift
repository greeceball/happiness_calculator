...
class EntryTableViewCell: UITableViewCell {
    ...
    func createObserver() {
        NotificationCenter.default.addObserver(self, selector: #selector(updateUI), name: notificationKey, object: nil) //default is a singleton from the notificationcenter class
    }
